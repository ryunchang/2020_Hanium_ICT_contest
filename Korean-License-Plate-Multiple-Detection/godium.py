...
for i in range(len(contours)):
    ...
    if (aspect_ratio >= MIN_RATIO) and (aspect_ratio<=MAX_RATIO) and (rect_area>=100) and (rect_area<=1200):
...
for k in range(len(box1)):     
     if box1[k][0]<width*0.33:
          box1_1[k]=box1[k]  
     elif box1[k][0]<width*0.66:
          box1_2[k]=box1[k]
     elif box1[k][0]<width:
          box1_3[k]=box1[k]
